...
export default {
  ...
  runtimeVersions: {
    ...
    dataDirectoryEnvRestart: '修改後請完全結束並重新開啟 Hermes Studio。若 Windows 或 Linux 桌面端仍讀取舊值，請登出並重新登入系統。',
  ...
  connections: {
    ...
    app: {
      ...
      accessFailures: {
        ...
        cloudSubscriptionRequired: '目前帳號尚未開通 HStudio Cloud，無法使用雲端連線',
