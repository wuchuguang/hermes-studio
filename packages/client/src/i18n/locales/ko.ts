...
export default {
  ...
  dshPlugins: {
    ...
    "listTab": "플러그인 목록",
    "webPackages": "설치된 Web 플러그인",
    "presetEntries": "프리셋 플러그인",
    "packageVersion": "버전",
    ...
    "nativeHint": "프리셋의 플러그인 항목입니다. 선택은 미리보기만 변경합니다. 상태는 실행 상태가 아닌 설정 상태입니다.",
    "nativeFailed": "프리셋 설정을 읽을 수 없습니다. DSH 설치와 파일을 확인하세요.",
    "searchPlugins": "플러그인 ID 또는 모듈 검색",
    "shipped": "기본 프리셋",
    "userPreset": "사용자 프리셋",
    "noEntries": "플러그인 항목 없음",
    "conditional": "조건부 활성화",
    "title": "플러그인",
    "install": "설치",
    "packageSpec": "패키지 이름과 정확한 버전",
    "dependency": "의존 패키지",
    "enabled": "설정에서 활성화됨",
    "disabled": "설정에서 비활성화됨",
    "remove": "제거",
    "removeConfirm": "다음 시작부터 {name}을 제거할까요?",
    "conflict": "설정이 변경되었습니다. 초안은 유지됩니다. 최신 버전과 비교한 뒤 다시 불러오세요.",
    "missingDependency": "먼저 DSH와 pnpm을 설치하세요.",
  },
  ...
  ekkoConfig: {
    ...
    "settingsModules": "모듈",
    "settingsAdvanced": "고급",
    "noDefaultProvider": "기본 Provider 없음",
    "authorized": "인증됨",
    "maxSteps": "최대 도구 라운드",
    "maxModelRetries": "모델 재시도 횟수",
    "maxToolFailures": "동일 도구 실패 복구 임계값",
    "backgroundDelegation": "백그라운드 위임",
    "subtaskMaxSteps": "하위 작업 도구 라운드",
    "defaultProvider": "기본 Provider",
    "defaultModel": "기본 모델",
    "requestTimeoutMs": "요청 시간 제한(ms)",
    "temperature": "Temperature",
    "maxTokens": "최대 출력 토큰",
    "reasoningEffort": "추론 강도",
    "reasoningSummary": "추론 요약",
    "authorizationLeewayMs": "인증 갱신 여유 시간(ms)",
    "toolsEnabled": "도구 활성화",
    "toolTimeoutMs": "도구 시간 제한(ms)",
    "approvalsEnabled": "도구 승인",
    "approvalTimeoutMs": "승인 시간 제한(ms)",
    "permanentAllow": "항상 허용할 도구",
    "codeExecEnabled": "코드 실행",
    "codeExecLanguages": "코드 실행 언어",
    "codeExecTimeoutMs": "코드 실행 시간 제한(ms)",
    "codeExecMaxCalls": "코드 실행 도구 호출 한도",
    "maxOutputBytes": "최대 출력 바이트",
    "maxStderrBytes": "최대 stderr 바이트",
    "maxSourceBytes": "최대 소스 바이트",
    "memoryEnabled": "메모리 활성화",
    "recentMessageLimit": "최근 메시지 한도",
    "recallTokenBudget": "자동 회상 토큰 예산",
    "memorySearchLimit": "메모리 검색 결과 한도",
    "skillsEnabled": "스킬 활성화",
    "skillReviewInterval": "도구 호출별 스킬 확인 간격",
    "mcpEnabled": "MCP 활성화",
    "logMaxBytes": "로그 파일 최대 바이트",
    "promptInstructions": "전역 Prompt 지침",
    ...
    "failureLimitHint": "같은 도구가 이 횟수만큼 연속 실패하면 모델이 호출을 수정하거나 다른 방법을 사용하도록 요청하며 실행은 계속됩니다.",
    ...
    "back": "뒤로",
    "refresh": "새로고침",
    "loadFailed": "Ekko 설정을 불러오지 못했습니다",
    "deleted": "삭제됨",
    "allStatuses": "모든 상태",
    "statusActive": "활성",
    ...
    "statusDeleted": "삭제됨",
    "memoryTitle": "메모리",
    "memoryDescription": "현재 프로필의 장기 메모리를 확인하고 관리합니다.",
    "searchMemory": "메모리 제목 또는 내용 검색…",
    "noMemory": "일치하는 메모리가 없습니다",
    "graphView": "관계 그래프",
    "listView": "목록",
    "memoryNodes": "노드",
    "memoryRelations": "관계",
    "relationRevision": "버전 기록",
    "relationSource": "동일한 출처",
    "relationEntity": "공유 엔터티",
    "relatedMemories": "관련 메모리",
    "noRelations": "직접 연결된 관계가 없습니다",
    "memoryKey": "메모리 키",
    "memoryCategory": "카테고리",
    "memoryEntities": "엔터티",
    "memoryUpdatedAt": "업데이트",
    "memoryScope": "범위",
    "memoryRevision": "리비전",
    "memoryConfidence": "신뢰도",
    "memoryImportance": "중요도",
    "memoryGraphHint": "노드를 선택하면 내용과 관계를 확인할 수 있습니다.",
    "editMemory": "메모리 편집",
    "deleteMemoryConfirm": "이 메모리를 소프트 삭제할까요?",
    "titleLabel": "제목",
    "contentLabel": "내용",
    "tagsLabel": "태그",
    "tagsPlaceholder": "쉼표로 태그 구분",
    "skillsTitle": "Ekko 스킬",
    "skillsDescription": "Ekko에서 사용할 재사용 가능한 지침을 만들고 편집합니다.",
    "newSkill": "새 스킬",
    "searchSkills": "스킬 검색…",
    "noSkills": "일치하는 스킬이 없습니다",
    "selectSkill": "스킬을 선택하거나 새로 만드세요",
    "skillName": "스킬 이름",
    "skillContent": "SKILL.md",
    "skillFormatHint": "SKILL.md에는 일치하는 name, description 및 간결한 영어 metadata.keywords가 있는 YAML frontmatter가 필요합니다.",
    "skillTemplateDescription": "Ekko가 이 스킬을 사용해야 하는 상황을 설명하세요.",
    "skillTemplateBody": "여기에 스킬 지침을 작성하세요.",
    "deleteSkillConfirm": "이 스킬을 보관할까요?",
    "mcpTitle": "MCP 서버",
    "mcpDescription": "Ekko가 런타임에 사용할 수 있는 로컬 및 원격 MCP 서버를 관리합니다.",
    "enabledServers": "활성화됨",
    "addServer": "서버 추가",
    "editServer": "서버 편집",
    "managed": "Studio 관리",
    "custom": "사용자 지정",
    "managedHint": "Studio 관리 서버 정의는 자동으로 주입되며 프로필별로 편집, 삭제, 활성화 또는 비활성화할 수 있습니다.",
    "noServers": "설정된 MCP 서버가 없습니다",
    "testServer": "테스트",
    "testSuccess": "테스트 완료: 도구 {count}개 발견",
    "testFailed": "연결 테스트 실패",
    "deleteServerConfirm": "이 MCP 서버를 삭제할까요?",
    "serverName": "서버 이름",
    "serverNamePlaceholder": "예: local-tools",
    "serverConfig": "서버 설정(JSON)",
    "serverConfigHint": "stdio에는 command/args/env를, 원격 MCP에는 type: streamable_http와 url/headers를 사용하세요.",
  ...
  agentManager: {
    ...
    manageRuntime: 'Runtime 관리',
    runtimeVersion: 'Runtime 버전',
    agentVersion: 'Hermes Agent 버전',
    path: '경로',
    userCli: 'Hermes CLI',
    userCliReadonly: '현재 환경의 Hermes CLI를 우선 검색하며 CLI는 사용자가 직접 관리합니다.',
    readOnly: '읽기 전용',
    noUserCli: '사용 가능한 Hermes CLI를 찾지 못했습니다',
    ...
    installOperation: '설치',
    deleteOperation: '삭제',
    aiHelpDialogTitle: '{name} 작업 실패',
    aiHelpDialogQuestion: '{name} {operation}에 실패했습니다. Ekko AI에게 진단을 요청할까요?',
    aiHelpDialogPositive: 'AI에게 질문',
    ...
    legacyDataMigrationSuccess: '이전이 예약되었습니다. Ekko Studio가 다시 시작되고 로컬 서비스 시작 전에 데이터를 이전합니다.',
  ...
  runtimeVersions: {
    ...
    activePythonPath: '현재 Python 경로',
    activeAgentRoot: '현재 Agent Root',
    viewCliDetails: '보기',
    cliDetailsTitle: 'Hermes CLI 세부 정보',
    activeDataDirectory: '현재 데이터 디렉터리',
    dataDirectoryEnvDescription: '이 디렉터리는 HERMES_HOME 환경 변수로 재정의될 수 있습니다. 경로가 올바르지 않으면 HERMES_HOME을 사용할 데이터 디렉터리로 설정하세요.',
    dataDirectoryEnvInstructions: '플랫폼별 환경 변수 설정 보기',
    dataDirectoryEnvWindows: 'Windows PowerShell(현재 사용자)',
    dataDirectoryEnvMacos: 'macOS(데스크톱 / 터미널)',
    dataDirectoryEnvLinux: 'Linux(로그인 환경)',
    dataDirectoryEnvDocker: 'Docker Compose',
    dataDirectoryEnvRestart: '변경 후 Ekko Studio를 완전히 종료했다가 다시 여세요. Windows 또는 Linux 데스크톱 앱에서 이전 값이 계속 보이면 로그아웃한 뒤 다시 로그인하세요.',
    cliUpdateDescription: 'Hermes Runtime 0.19.1 이상에서는 다음 명령으로 내장 Hermes Agent만 업데이트할 수 있습니다. Ekko Studio 데스크톱 앱이나 Web UI는 업데이트되지 않습니다. 실행 전에 Ekko Studio를 완전히 종료하세요:',
    webUiTitle: 'Web UI',
    platform: '플랫폼',
    ...
    runtimeDirectorySaved: 'Runtime 마이그레이션을 예약했습니다. Ekko Studio를 다시 시작하면 실행됩니다.',
    runtimeMigrationPending: '마이그레이션 예정 위치: {directory}',
    runtimeMigrationFailed: '저장소 마이그레이션에 실패하여 이전 저장소를 계속 사용합니다',
    runtimeActivationFailed: '선택한 Runtime을 시작할 수 없어 Ekko Studio가 설치된 다른 버전을 사용했습니다',
    active: '활성',
    installed: '설치됨',
    download: '다운로드',
    ...
    activateSuccess: '버전 선택이 저장되었습니다. Ekko Studio를 다시 시작하면 적용됩니다.',
  ...
  connections: {
    ...
    app: {
      ...
      scanToAdd: '스캔하여 추가',
      purchaseAccess: '요금제 보기',
      viewList: '목록',
      viewDownload: '다운로드',
      viewMessages: '메시지 전송',
      downloadTitle: '휴대폰에서 Ekko Studio 사용하기',
      downloadDescription: '현재 비공개 베타 테스트 중이며 가입하려면 등록 코드가 필요합니다. 일부 등록 코드는 소셜 미디어를 통해 공개할 예정입니다.',
      downloadPaidDescription: 'Ekko Studio App이 정식 출시되었으며 현재 유료로 제공됩니다. 이용하려면 요금 및 구매 페이지에서 적합한 플랜을 선택하고 구매를 완료해 주세요.',
      ...
      accessFailureTitle: '최근 App 연결 실패',
      accessFailureMode: '현재 모드: {mode}',
      accessFailureDeviceName: '기기: {deviceName}',
      accessFailureTime: '실패 시간: {time}',
      accessModes: {
        internal: '내부 테스트',
        public_beta: '공개 베타',
        paid: '유료',
      ...
      accessFailures: {
        ...
        paidAccountRequired: '현재 계정은 유료 계정이 아니므로 이 기능을 사용할 수 없습니다',
        cloudSubscriptionRequired: '이 계정에는 Ekko Studio Cloud 이용 권한이 없습니다',
        appAccessExpired: '내부 테스트 또는 공개 베타 이용 기간이 만료되었습니다',
        required: 'App에서 접근 권한을 제공하지 않았습니다',
        invalid: 'App 접근 권한이 유효하지 않습니다',
        expired: 'App 접근 권한이 만료되었습니다',
        accountMismatch: '권한의 계정이 현재 App 계정과 일치하지 않습니다',
        deviceMismatch: '권한의 기기 코드가 이 기기와 일치하지 않습니다',
        unknown: 'App 접근 권한 확인에 실패했습니다',
      },
      deviceName: '기기 이름',
      deviceBrand: '기기 브랜드',
      deviceModel: '기기 모델',
  ...
  chat: {
    ...
    pushEnabled: '푸시 사용',
    pushNotConfigured: '활성화하기 전에 Ekko Studio의 “기기 연결”에서 메시지 푸시를 설정하세요.',
  ...
  settings: {
    ...
    voice: {
      ...
      hermesConfigDescription: 'Hermes 프로필의 기존 네이티브 제공자는 유지되며 Web UI 제공자는 Ekko Studio로 표시됩니다.',
      ...
      useHermesStudioProvider: 'Ekko Studio 제공자 사용',
  ...
  changelog: {
    ...
    new_0_7_22_4: 'Hermes Bridge의 Studio 관리 Claude OAuth를 수정하고 로컬 소켓 경로가 너무 길면 TCP로 전환 (#3033, #3048)',
    new_0_7_22_5: '전역 Coding Agent 세션의 Studio MCP 도구를 보완하고 실행 파일 검색 경로와 명령을 찾지 못했을 때의 오류 안내 개선 (#3044, #3055)',
    new_0_7_22_6: 'Studio에서 생성하는 DSH 플러그인 매니페스트에 버전을 선언하여 호환성 수정 (#3038)',
    new_0_7_22_7: 'API URL 설정 이전 시 비어 있는 BASE_URL이 다음 줄 설정을 잘못 읽는 문제 수정 (#3046)',
    new_0_7_22_8: 'OpenRouter 요청의 앱 표시 이름을 Ekko Studio로 통일 (#3056)',
    new_0_7_22_9: 'Grok 개별 세션 설정에서 여러 줄 배열, 문자열 및 테이블 배열이 잘리거나 잘못 분리되는 문제 수정 (#3072)',
    new_0_7_22_10: '데스크톱 런타임 패키징 시 브라우저 실행 권한과 심볼릭 링크가 손실되는 문제를 수정하고 Hermes 0.21.3 지원. 런타임 릴리스가 최신 데스크톱 릴리스 표시를 덮어쓰지 않도록 수정 (#3073)',
    new_0_7_21_1: 'Windows에서 잘못된 시작 스크립트 선택으로 DSH 플러그인 설정 및 Agent 프리셋 페이지가 열리지 않던 문제 수정 (#3026)',
    new_0_7_21_2: 'DSH 설정 런타임 시작 오류에 실패 단계와 시스템 오류 코드 또는 종료 코드를 표시하며, 플러그인 로그와 인증 정보는 노출하지 않음 (#3026)',
    new_0_7_20_1: 'DeepSeek Harness(DSH) 설치 관리와 개인 채팅·그룹 채팅·워크플로 연동을 추가. Agent 프리셋 선택과 재개 시 모드 유지를 지원하고 영문·중문 가이드를 갱신 (#3020, #3023)',
    new_0_7_20_2: 'DSH 기본 Web 플러그인 설정, 플러그인 목록, Agent 프리셋 관리를 추가. 복사·기본값 선택·사용자 프리셋 삭제를 지원하며 백엔드 호스트에 DSH와 Web 의존성 설치 필요 (#3020)',
    new_0_7_20_3: '그룹 채팅 Agent 생성·편집을 오른쪽 서랍으로 변경. 양식은 스크롤 가능하고 작업 버튼은 고정되며 모바일에서는 전체 너비 사용 (#3020)',
    new_0_7_20_4: 'Coding Agent 페이지의 공유 스킬을 읽기 전용으로 변경해 실수로 수정하거나 삭제하는 것을 방지. DSH 전용 스킬은 계속 편집 가능 (#3020)',
    new_0_7_20_5: 'Pi 설치·업데이트에 최신 npm 버전을 사용하고 사용자가 활성화한 MCP 어댑터를 우선하여 도구와 인수의 중복 등록 방지 (#2999, #2991)',
    new_0_7_20_6: '전역 Coding Agent 사용량과 모델 연결을 수정. 완료된 응답의 사용량을 보존하고 캐시 토큰 집계를 개선하며 과거 기록은 소급 보완하지 않음 (#3005)',
    new_0_7_20_7: 'Grok 실패 턴의 사용량 손실, 사용자 지정 제공자의 컨텍스트 범위, 추론 강도 변경 후 실행 설정 갱신 문제 수정 (#3002)',
    new_0_7_20_8: 'Docker에서 Studio로 설치한 Coding Agent를 Studio 데이터 볼륨에 보관해 컨테이너 재생성·업데이트 후에도 유지. 이전 이미지에서 설치한 Agent는 한 번 재설치 필요 (#3006)',
    new_0_7_20_9: 'OpenCode가 지원하지 않는 /compact 명령을 숨김. 직접 입력하면 현재 작업을 중단하지 않고 제한 사항 안내 (#3010)',
    new_0_7_20_10: 'Hermes Agent 0.21 이상에서 승인 세션 연결을 수정하고 이전 런타임과의 호환성 유지 (#3018)',
    new_0_7_20_11: 'apikey 기본 도메인을 apikey.fan으로 갱신하고 시작 시 기존 Hermes 설정의 이전 엔드포인트를 한 번 이전. 경로·키·모델 설정 보존 (#3022)',
    new_0_7_20_12: 'Linux 실행기·창 아이콘의 둥근 모서리와 투명 여백을 개선해 시각적 크기 조정 (#3008)',
    new_0_7_19_1: '제품명을 Ekko Studio로 변경하고 앱 아이콘, 공식 도메인, CLI 명령, 제품 문서를 통일 (#2966, #2980, #2981, #2992, #2994)',
    new_0_7_19_2: '데스크톱 재시작 반복, 업데이트 중단, 시작 실패를 수정하고 업그레이드 후 로그인 및 브라우저 데이터를 유지하며 Windows 시작 설정을 이전 (#2931, #2979, #2988)',
    new_0_7_19_3: '기본 OpenCode Free 제공자를 추가해 API Key 없이 채팅 생성과 Coding Agent 사용을 지원하고 모델 목록을 백그라운드에서 로드 (#2932)',
    new_0_7_19_4: 'Ekko 및 Studio 프록시를 거치는 Coding Agent의 OpenCode 세션 호환성을 수정. Hermes는 별도 Runtime 업데이트 필요 (#2996)',
    new_0_7_19_5: 'Ekko가 작업 계획을 저장하고 실시간 진행 카드를 표시하며, 위임한 백그라운드 작업이 실행 중이면 사이드바 작업 표시를 유지 (#2952, #2961)',
    new_0_7_19_6: '채팅 파일 링크에서 인용한 줄로 이동하고 강조 표시. 작업 공간 파일 트리는 상태를 유지하며 빈 공간 없이 접기 가능 (#2947, #2965)',
    new_0_7_19_7: '데스크톱 웹 링크를 내장 또는 시스템 브라우저로 열도록 선택 가능. 내장 패널은 페이지 로드가 끝나기 전에 즉시 표시 (#2928, #2956)',
    new_0_7_19_8: '브라우저 주석의 개별 삭제와 실행 취소를 지원하고 탭 닫기 및 주석 정리 오류를 수정 (#2949, #2944)',
    new_0_7_19_9: '읽어주기에서 숨겨진 추론을 제외하고 음수·백분율 등 의미 있는 기호를 보존. Doubao TTS는 0.5–2배속을 지원하며 현재 프로필과 동기화 (#2945, #2950, #2978)',
    new_0_7_19_10: 'Hermes와 Ekko 스킬 목록의 활성화·비활성화 스위치 기본 표시를 복원 (#2933)',
    new_0_7_19_11: '업데이트된 App에서 채팅 승인·확인·실행 종료, 그룹 Agent 답변, 워크플로 완료·실패의 포그라운드 알림을 지원하고 연결 종료 후 릴레이 정리를 수정 (#2940, #2946)',
    new_0_7_19_12: '업데이트된 App에서 세션 분류별 독립 페이지 로드를 지원하고 고정 세션 필터와 분류별 총수를 정확히 반환 (#2977, #2982)',
    new_0_7_19_13: '호환 App에서 사용자 확인 후 개인 채팅을 통해 iOS 걸음 수·수면·심박수 등 건강 데이터를 읽기 전용으로 조회. Android는 아직 미지원 (#2972)',
    new_0_7_19_14: '최신 공지만 표시하고 닫기 상태를 기억하는 Studio 공지 대화상자를 추가. 조회 실패 시에도 사용에 영향 없음 (#2989)',
    new_0_7_19_15: 'Codex 여러 줄 설정과 Hook 테이블 보존, 프로필 재시작의 조기 시간 초과, 선택 패치 실패로 인한 Docker 시작 중단을 수정 (#2951, #2960, #2969)',
    new_0_7_19_16: 'Agent 자동 업데이트 정책의 기반 코드를 추가. UI와 백그라운드 업데이트는 아직 활성화되지 않아 Agent를 자동 업그레이드하지 않음 (#2923)',
    new_0_7_18_1: 'OpenCode Coding Agent를 추가하여 세션 재개, 스트리밍 도구 호출, 설정, 메모리, Skills, 워크플로 및 그룹 채팅 지원 (#2890)',
    new_0_7_18_2: '그룹 채팅에서 클라우드 릴레이를 통한 원격 Agent 연결을 지원하고 출력 순서, 재연결, 요약 복원, 공유 이미지 접근, 도구 접기 및 모바일 레이아웃 개선 (#2927)',
    new_0_7_18_3: '모바일 일회성 위치 조회, 캘린더 및 미리 알림 기능 추가. 민감한 작업은 동의가 필요하며 삭제는 확인된 항목으로 제한하고 동의 시간 초과와 요청 출처 검증 (#2820, #2926)',
    new_0_7_18_4: '세션 작업 메뉴를 통합하고 이동 시 카테고리 생성, 새로고침 후 접힘 상태 유지, Ctrl/Cmd + , 설정 단축키 추가 (#2887, #2896, #2910, #2912)',
    new_0_7_18_5: '전송 전 업로드 이미지, 코드 형식의 로컬 파일 링크 및 작업 공간 Markdown 미리 보기를 지원하고 메시지 참조 개선 및 답장 화살표 복원 (#2885, #2893, #2903, #2908)',
    new_0_7_18_6: 'Runtime 다운로드 폴링을 슈퍼 관리자에게 필요한 경우에만 실행. Windows 압축 해제는 독립 디렉터리를 사용하고 시스템 tar가 없으면 Node tar로 대체하며 분리된 Hermes Runtime의 Bridge MCP 가져오기 수정 (#2925)',
    new_0_7_18_7: 'Coding Agent가 실패한 MCP Runtime을 격리하고 제거된 서버를 정리. Studio 관리 MCP 실행기는 Node 모드를 명시하여 추가 Electron 창 실행 방지 (#2888, #2920)',
    new_0_7_18_8: 'Ekko가 반복된 도구 실패에서 복구할 수 있도록 재시도 및 실패 처리 개선 (#2891)',
    new_0_7_18_9: '빈 환경 변수 값이 다음 줄을 읽는 문제를 수정하여 잘못된 모델 URL 및 인증 정보 방지 (#2884)',
    new_0_7_18_10: '앱 다운로드 페이지에 구매 링크를 추가하고 버전 매니페스트의 접근 모드에 따라 표시 (#2895)',
    ...
    new_0_7_13_2: 'Hermes 채팅을 만들 때 이제 가벼운 Agent 가용성 상태를 재사용합니다. Hermes가 설치되지 않은 경우 관리자만 설치 화면으로 안내하며, 상태 확인 실패가 더 이상 채팅 생성을 막지 않습니다 (#2805)',
    new_0_7_13_3: 'Desktop, 백엔드 Bridge, CLI가 이제 잠긴 하나의 Hermes 환경 선택을 공유합니다. 버전 관리에서 활성 CLI, 환경 세부 정보, 데이터 디렉터리 재정의 안내를 표시하고 누락된 Runtime을 필요할 때 설치할 수 있습니다 (#2808)',
    new_0_7_12_1: 'Windows에서 Hermes 데이터 경로를 %USERPROFILE%\\.hermes로 통일하면서 HERMES_HOME을 계속 지원하여 Desktop과 백엔드가 동일한 Profile을 사용합니다(#2795)',
    new_0_7_12_2: 'Windows의 Ekko와 Hermes 시작 과정이 잠긴 Skill 초기화를 나중에 다시 시도하고 명령 shim을 올바르게 실행하여 EPERM 및 spawn EINVAL 시작 오류를 방지합니다(#2796)',
    new_0_7_12_3: 'Ekko가 불완전한 모델 도구 호출을 거부하고 재시도 전에 잘못된 도구 호출 기록을 제거하여 function, name 또는 arguments가 비어 발생하는 오류를 방지합니다(#2796)',
    new_0_7_12_4: '데이터베이스, Skills, 메모리 및 로그가 독립적으로 저하될 수 있습니다. Core 채팅은 계속 사용 가능하고, 사용할 수 없는 모듈은 명확히 표시되며, 각 장애의 원인과 복구 컨텍스트를 제공합니다(#2797)',
    new_0_7_12_5: 'Ekko가 안전한 복구와 복구 후 자체 점검을 자동 실행합니다. 내장 Skills와 로그 디렉터리를 복원하고, 데이터베이스를 재시도하거나 백업 후 재구축하며, 실행 중인 Run이 끝나면 Studio가 영구 저장소를 다시 로드합니다(#2797)',
    new_0_7_11_1: 'Ekko가 기존 형식과 Responses 형식의 OpenAI 호환 페이로드 모두에서 DeepSeek 추론 응답과 도구 호출을 처리합니다(#2788)',
    new_0_7_11_2: 'Agent Bridge가 셸로 감싼 런타임 시작을 복구하고 관련 없는 하위 프로세스를 무시하며 실제 broker 준비 신호를 기다립니다(#2789)',
    new_0_7_11_3: '대기 중인 승인, 질문 및 선택 항목에 동기화된 카운트다운을 표시하고 안전하게 재개하며 채팅과 그룹 채팅의 오래된 시간 초과 오류를 방지합니다(#2790)',
    new_0_7_11_4: '업그레이드 시 Skill 디렉터리 전체를 내장 Skills로 한 번만 교체하고 완료 표시를 원자적으로 저장하여 이후 Windows 시작에서 Git 디렉터리 삭제로 인한 충돌을 방지합니다(#2792)',
    new_0_7_11_5: '잘못된 WebSocket 요청과 로그, Runtime, Ekko 또는 데이터베이스 초기화 오류로부터 시작을 보호합니다. Desktop은 빠르게 열리고 정상 흐름을 바꾸지 않으면서 백엔드나 renderer 종료를 복구합니다(#2792)',
    new_0_7_1_1: 'Ekko 메모리 쓰기와 삭제가 시간 초과나 오래된 카드 복원을 일으킬 수 있는 모델 승인 및 백그라운드 검토 큐 없이 저장된 메모리를 직접 갱신합니다(#2785)',
    new_0_7_1_2: '숨겨진 롤링 세션 요약 파이프라인과 관련 검토 워커, 설정, API, UI 상태 및 데이터베이스 테이블을 제거했습니다(#2785)',
    new_0_7_1_3: '전체 메모리 조회와 전체 삭제가 안정적으로 동작하고, 메모리 도구 실패 시 명확한 오류로 실행을 중단합니다. 데이터베이스 업그레이드는 잠금 재시도, 원본 백업, 스키마 재구축 및 호환 데이터 복구를 지원합니다(#2785)',
    new_0_7_0_1: '이번 릴리스에는 v0.6.47 이후 병합된 21개 PR이 모두 포함되며, Ekko 완전 통합, 통합 Agent 런타임 관리, 향상된 채팅 상태 유지, 더 안전한 Studio 호환성을 제공합니다',
    new_0_7_0_2: 'Ekko는 이제 Studio가 완전히 관리하는 런타임으로서 Profile Agent, 대화, 관리형 메모리, 기본 및 외부 스킬, MCP 서버, 전용 설정 페이지를 지원합니다 (#2752, #2770)',
    new_0_7_0_3: 'Ekko는 병렬 실행이 안전한 도구 호출을 동시에 처리하고 버전이 지정된 전역 Agent 설정을 저장하며, Navicat에서 확인하기 쉬운 단일 ekko.db를 포함한 모든 개발 데이터를 packages/ekko-agent/.ekko에 보관합니다. 또한 자체 전용 스킬만 자동 설치하고 Hermes 스킬은 복사하지 않습니다 (#2772, #2775, #2776)',
    new_0_7_0_4: '통합된 Agents 관리자는 Hermes Runtime 검색, 선택, 시작, 재시작, 공급자 토큰, 실시간 상태를 관리합니다. 페이지를 열 때 캐시된 상태를 사용하고 시간이 오래 걸리는 검색은 새로 고침할 때만 수행합니다 (#2760, #2761)',
    new_0_7_0_5: '채팅은 화면 이동 후에도 사고 경과 시간을 유지하고, 재사용된 도구 호출 ID를 실행별로 분리하며, 중지·정리·서버 재시작 후에도 전역 Coding Agent 컨텍스트를 이어갑니다 (#2723, #2730, #2735)',
    new_0_7_0_6: '첨부 파일 전송은 올바른 콘텐츠 유형, 분할 업로드·다운로드, 진행률, 취소, 안전한 파일 이름, 동영상 미리보기를 지원합니다. Codex 요청은 현재 턴의 이미지를 유지하면서 과거 인라인 이미지를 제거합니다 (#2732, #2773)',
    new_0_7_0_7: '최근 목록에서 채팅을 선택하면 화면 이동과 새로 고침 후에도 실제 카테고리의 접힘 상태가 유지되며, 개인 및 그룹 채팅에는 올바른 Profile, 멤버, Agent 신원이 표시됩니다 (#2742, #2754, #2755)',
    new_0_7_0_8: '전역 Coding Agent 채팅에서 효과가 없는 추론 강도 선택기를 숨겼으며, Weixin 연결 알림에 전달 제한과 알림을 복원하는 방법을 추가했습니다 (#2728, #2731)',
    new_0_7_0_9: '서버 책임을 정식 Studio, Hermes, Ekko, Coding Agent 모듈로 나누면서 기존 MCU 경로 호환성을 유지하고, 종료 시 Studio 소유 프로세스 트리를 안정적으로 정리합니다 (#2744, #2746, #2747)',
    new_0_7_0_10: '영문 및 중문 README에서 다섯 개 런타임, 세 Agent 제품군, 모듈 소유권, 정식 API, 현재 개발 및 검증 흐름을 설명하도록 갱신했습니다 (#2745)',
    new_0_7_0_11: '기기 연결에서 Android와 iOS 다운로드 카드만 표시하며, Apple 정식 버전은 TestFlight · App Store 대신 App Store로 표시합니다',
  },
}
