...
export default {
  ...
  runtimeVersions: {
    ...
    dataDirectoryEnvRestart: '変更後は Hermes Studio を完全に終了して再度開いてください。Windows または Linux のデスクトップアプリで古い値が残る場合は、サインアウトして再度サインインしてください。',
  ...
  connections: {
    ...
    app: {
      ...
      accessFailures: {
        ...
        cloudSubscriptionRequired: 'このアカウントには HStudio Cloud の利用権限がありません',
