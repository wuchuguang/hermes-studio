...
export default {
  ...
  dshPlugins: {
    ...
    "listTab": "プラグイン一覧",
    "webPackages": "インストール済み Web プラグイン",
    "presetEntries": "プリセット内のプラグイン",
    ...
    "nativeHint": "プリセット内のプラグインです。選択はプレビューのみを変更します。状態は設定値であり、実行状態ではありません。",
    ...
    "title": "プラグイン",
    "install": "インストール",
    "packageSpec": "パッケージ名と固定バージョン",
    "dependency": "依存パッケージ",
    "enabled": "設定で有効",
    "disabled": "設定で無効",
    "remove": "削除",
    "removeConfirm": "次回起動から {name} を削除しますか？",
    "conflict": "設定が変更されました。下書きは保持されています。最新版と比較して再読み込みしてください。",
    "missingDependency": "先に DSH と pnpm をインストールしてください。",
  },
  ...
  ekkoConfig: {
    ...
    "settingsAdvanced": "詳細",
    "noDefaultProvider": "既定のプロバイダーなし",
    "authorized": "認証済み",
    "maxSteps": "最大ツールラウンド数",
    "maxModelRetries": "モデル再試行回数",
    "maxToolFailures": "同一ツール失敗の再検討しきい値",
    "backgroundDelegation": "バックグラウンド委任",
    "subtaskMaxSteps": "サブタスクのツールラウンド数",
    ...
    "reasoningSummary": "推論要約",
    "authorizationLeewayMs": "認証更新の余裕時間（ms）",
    "toolsEnabled": "ツールを有効化",
    "toolTimeoutMs": "ツールタイムアウト（ms）",
    "approvalsEnabled": "ツール承認",
    "approvalTimeoutMs": "承認タイムアウト（ms）",
    "permanentAllow": "常に許可するツール",
    "codeExecEnabled": "コード実行",
    "codeExecLanguages": "コード実行言語",
    "codeExecTimeoutMs": "コード実行タイムアウト（ms）",
    "codeExecMaxCalls": "コード実行のツール呼び出し上限",
    "maxOutputBytes": "最大出力バイト数",
    "maxStderrBytes": "最大 stderr バイト数",
    "maxSourceBytes": "最大ソースバイト数",
    "memoryEnabled": "メモリを有効化",
    "recentMessageLimit": "直近メッセージ上限",
    "recallTokenBudget": "自動想起トークン予算",
    "memorySearchLimit": "メモリ検索結果上限",
    "skillsEnabled": "スキルを有効化",
    "skillReviewInterval": "ツール呼び出しごとのスキル確認間隔",
    "mcpEnabled": "MCP を有効化",
    "logMaxBytes": "ログファイルの最大バイト数",
    "promptInstructions": "グローバル Prompt 指示",
    "schemaVersion": "設定スキーマバージョン",
    ...
    "failureLimitHint": "同じツールがこの回数連続で失敗すると、モデルに呼び出しの修正または別の方法を求めます。実行は継続します。",
    ...
    "back": "戻る",
    "refresh": "更新",
    "loadFailed": "Ekko 設定を読み込めませんでした",
    "deleted": "削除済み",
    "allStatuses": "すべての状態",
    "statusActive": "有効",
    "statusSuperseded": "置換済み",
    "statusExpired": "期限切れ",
    "statusDeleted": "削除済み",
    "memoryTitle": "メモリ",
    "memoryDescription": "現在のプロファイルの長期メモリを確認・管理します。",
    "searchMemory": "メモリのタイトルまたは内容を検索…",
    "noMemory": "一致するメモリはありません",
    "graphView": "関連グラフ",
    "listView": "リスト",
    "memoryNodes": "ノード",
    "memoryRelations": "関係",
    "relationRevision": "バージョン履歴",
    "relationSource": "同じソース",
    "relationEntity": "共通エンティティ",
    "relatedMemories": "関連メモリ",
    "noRelations": "直接の関連はありません",
    "memoryKey": "メモリキー",
    "memoryCategory": "カテゴリ",
    "memoryEntities": "エンティティ",
    "memoryUpdatedAt": "更新日時",
    "memoryScope": "スコープ",
    "memoryRevision": "リビジョン",
    "memoryConfidence": "信頼度",
    "memoryImportance": "重要度",
    "memoryGraphHint": "ノードを選択すると、内容と関連を確認できます。",
    "editMemory": "メモリを編集",
    "deleteMemoryConfirm": "このメモリを論理削除しますか？",
    "titleLabel": "タイトル",
    "contentLabel": "内容",
    "tagsLabel": "タグ",
    "tagsPlaceholder": "タグをカンマ区切りで入力",
    "skillsTitle": "Ekko スキル",
    "skillsDescription": "Ekko が使用できる再利用可能な指示を作成・編集します。",
    "newSkill": "新しいスキル",
    "searchSkills": "スキルを検索…",
    "noSkills": "一致するスキルはありません",
    "selectSkill": "スキルを選択するか新規作成してください",
    "skillName": "スキル名",
    "skillContent": "SKILL.md",
    "skillFormatHint": "SKILL.md には、一致する name、description、簡潔な英語の metadata.keywords を含む YAML frontmatter が必要です。",
    "skillTemplateDescription": "Ekko がこのスキルを使用する条件を説明してください。",
    "skillTemplateBody": "ここにスキルの指示を記述します。",
    "deleteSkillConfirm": "このスキルをアーカイブしますか？",
    "mcpTitle": "MCP サーバー",
    "mcpDescription": "Ekko が実行時に使用できるローカルおよびリモート MCP サーバーを管理します。",
    "enabledServers": "有効",
    "addServer": "サーバーを追加",
    "editServer": "サーバーを編集",
    "managed": "Studio 管理",
    "custom": "カスタム",
    "managedHint": "Studio 管理のサーバー定義は自動的に注入され、プロファイルごとに編集、削除、有効化、無効化できます。",
    "noServers": "MCP サーバーが設定されていません",
    "testServer": "テスト",
    "testSuccess": "テスト完了：{count} 個のツールを検出",
    "testFailed": "接続テストに失敗しました",
    "deleteServerConfirm": "この MCP サーバーを削除しますか？",
    "serverName": "サーバー名",
    "serverNamePlaceholder": "例：local-tools",
    "serverConfig": "サーバー設定（JSON）",
    "serverConfigHint": "stdio には command/args/env、リモート MCP には type: streamable_http と url/headers を使用します。",
  ...
  agentManager: {
    ...
    manageRuntime: 'Runtime を管理',
    runtimeVersion: 'Runtime バージョン',
    agentVersion: 'Hermes Agent バージョン',
    path: 'パス',
    userCli: 'Hermes CLI',
    userCliReadonly: '現在の環境にある Hermes CLI を優先的に検出します。CLI はユーザーが管理します。',
    readOnly: '読み取り専用',
    noUserCli: '利用可能な Hermes CLI が検出されませんでした',
    ...
    deleteOperation: '削除',
    aiHelpDialogTitle: '{name} の操作に失敗しました',
    aiHelpDialogQuestion: '{name} の{operation}に失敗しました。Ekko AI に診断を依頼しますか？',
    aiHelpDialogPositive: 'AI に質問',
    ...
    legacyDataMigrationSuccess: '移行を予約しました。Ekko Studio を再起動し、ローカルサービスの開始前にデータを移行します。',
  ...
  runtimeVersions: {
    ...
    activePythonPath: '現在の Python パス',
    activeAgentRoot: '現在の Agent Root',
    viewCliDetails: '表示',
    cliDetailsTitle: 'Hermes CLI の詳細',
    activeDataDirectory: '現在のデータディレクトリ',
    dataDirectoryEnvDescription: 'このディレクトリは HERMES_HOME 環境変数で上書きされる場合があります。正しくない場合は、使用するデータディレクトリを HERMES_HOME に設定してください。',
    dataDirectoryEnvInstructions: '各プラットフォームの環境変数設定を表示',
    dataDirectoryEnvWindows: 'Windows PowerShell（現在のユーザー）',
    dataDirectoryEnvMacos: 'macOS（デスクトップ / ターミナル）',
    dataDirectoryEnvLinux: 'Linux（ログイン環境）',
    dataDirectoryEnvDocker: 'Docker Compose',
    dataDirectoryEnvRestart: '変更後は Ekko Studio を完全に終了して再度開いてください。Windows または Linux のデスクトップアプリで古い値が残る場合は、サインアウトして再度サインインしてください。',
    cliUpdateDescription: 'Hermes Runtime 0.19.1 以降では、次のコマンドで内蔵 Hermes Agent のみを更新できます。Ekko Studio デスクトップアプリや Web UI は更新されません。実行前に Ekko Studio を完全に終了してください：',
    webUiTitle: 'Web UI',
    platform: 'プラットフォーム',
    ...
    runtimeDirectorySaved: 'Runtime の移行を予約しました。Ekko Studio を再起動すると実行されます。',
    runtimeMigrationPending: '移行先：{directory}',
    runtimeMigrationFailed: '保存先の移行に失敗したため、以前の保存先を引き続き使用します',
    runtimeActivationFailed: '選択した Runtime を起動できなかったため、Ekko Studio は別のインストール済みバージョンを使用しています',
    active: '有効',
    installed: 'インストール済み',
    download: 'ダウンロード',
    ...
    activateSuccess: 'バージョン選択を保存しました。Ekko Studio を再起動すると反映されます。',
  ...
  mcuDevices: {
    title: 'Little Box',
    subtitle: '音声対話デバイス Little Box とその接続を管理',
    name: 'Name',
  ...
  connections: {
    ...
    app: {
      subtitle: 'App をデバイスに接続',
      scanToAdd: 'スキャンして追加',
      purchaseAccess: 'プランを見る',
      viewList: '一覧',
      viewDownload: 'ダウンロード',
      viewMessages: 'メッセージ送信',
      downloadTitle: 'スマートフォンで Ekko Studio を使う',
      downloadDescription: '現在クローズドベータ中です。登録には登録コードが必要で、今後ソーシャルメディアで一部のコードを配布します。',
      downloadPaidDescription: 'Ekko Studio App は正式にリリースされ、現在は有料でご利用いただけます。ご利用になるには、料金・購入ページで最適なプランを選び、購入手続きを完了してください。',
      downloadScan: 'スマートフォンでスキャン',
      downloadScanHint: 'Android 版をダウンロードできます',
      available: 'ダウンロード可能',
      testVersion: 'テスト版',
      comingSoon: '近日公開',
      notReleased: '未リリース',
      downloadRequirements: 'Android 6.0 以降 · ARM64',
      iosPending: 'App Store 版を準備中です',
      downloadApk: 'Android 版をダウンロード',
      scanModalTitle: 'スキャンして接続',
      lanConnection: 'LAN 接続',
      cloudConnection: 'クラウド接続',
      remainingTime: '残り {time}',
      authorizationExpired: '認証コードの有効期限が切れました',
      regenerate: '再生成',
      refreshQr: 'QRコードを更新',
      cloudPending: 'クラウド接続はまだ設定されていません',
      authorizationFailed: 'App 認証コードの生成に失敗しました',
      refreshTooSoon: '更新が頻繁すぎます。しばらくしてから再試行してください',
      refreshLimitReached: 'この接続の QR コード更新上限に達しました',
      preconnectionExpired: '事前接続の有効期限が切れました。スキャン画面を開き直してください',
      cloudUnavailable: 'クラウドサービスに接続できません。後でもう一度お試しください',
      accessFailureTitle: '最新の App 接続エラー',
      accessFailureMode: '現在のモード：{mode}',
      accessFailureDeviceName: 'デバイス：{deviceName}',
      accessFailureTime: '失敗日時：{time}',
      accessModes: {
        internal: '内部テスト',
      ...
      accessFailures: {
        ...
        paidAccountRequired: '現在のアカウントは有料アカウントではないため、この機能を利用できません',
        cloudSubscriptionRequired: 'このアカウントには Ekko Studio Cloud の利用権限がありません',
        appAccessExpired: '内部テストまたはパブリックベータの利用期限が切れています',
        required: 'App からアクセス権限が送信されていません',
        invalid: 'App のアクセス権限が無効です',
        expired: 'App のアクセス権限が期限切れです',
        accountMismatch: '権限のアカウントが現在の App アカウントと一致しません',
        deviceMismatch: '権限のデバイスコードがこのデバイスと一致しません',
        unknown: 'App のアクセス権限を確認できませんでした',
      },
      deviceName: 'デバイス名',
      deviceBrand: 'デバイスブランド',
      deviceModel: 'デバイスモデル',
      deviceCode: 'デバイスコード',
      connectionDetected: 'App が接続されました',
      connectionType: '接続方式',
      authorizedUser: '承認ユーザー',
      connectionTypes: {
        lan: 'ローカルネットワーク',
        cloud: 'クラウド',
      },
      connectionStatus: '接続状態',
      authorizationStatus: '認証状態',
      online: 'オンライン',
      offline: 'オフライン',
      active: '有効',
      expired: '期限切れ',
      actions: '操作',
      delete: '削除',
      deleteConfirm: '「{name}」の App 接続を削除しますか？',
      deleted: 'App 接続を削除しました',
      deleteFailed: 'App 接続を削除できませんでした',
      empty: '接続済みの App はありません',
      loadFailed: '接続済み App を読み込めませんでした',
    },
  },

  devices: {
    title: 'デバイス',
    subtitle: '接続済みデバイス、ペアリング要求、リモートアクセスを管理',
    count: '{count} 台のデバイス',
  ...
  chat: {
    ...
    pushNotConfigured: '有効にする前に、Ekko Studio の「デバイス接続」でメッセージプッシュを設定してください。',
    hideToolCalls: 'ツール呼び出しを非表示',
    messageQueue: 'メッセージキュー',
    removeQueuedMessage: 'キューのメッセージを削除',
    insertQueuedMessage: 'キュー内のメッセージを挿入',
    queueInsertionPending: '別のキューメッセージを挿入中です',
    queueInsertionWaitingTools: '現在のツールの完了を待っています',
    queueInsertionStopping: '現在の応答を停止しています',
    stop: '停止',
    send: '送信',
  ...
  models: {
    ...
    fallbackReorderHint: '行をドラッグすると Hermes が試す順序を変更できます。キーボードでは行を選択して Alt と上下矢印キーを押します。',
    fallbackRowAria: 'フォールバック {position}/{total}',
    fallbackEmpty: 'フォールバックモデルはまだありません。',
    fallbackSaved: 'フォールバック構成を保存しました',
    fallbackSaveFailed: 'フォールバック構成の保存に失敗しました',
    fallbackLoadFailed: 'フォールバック構成の読み込みに失敗しました',
    fallbackAppliesToNewSessions: '保存後に開始したセッションに適用されます。実行中のセッションは開始時の構成のままです。',
    ...
    auxiliaryTasksTitle: '補助タスク用モデル',
    delegationTitle: 'サブエージェントのデフォルトモデル',
    delegationSubtitle: '委任で作成されるサブエージェントが使用します。未設定の場合はメインモデルを継承します。',
    delegationInheritMain: 'メインモデルに従う',
    delegationInheritReasoning: 'メインセッションに従う',
    delegationReset: '継承に戻す',
    delegationFormHint: 'これはプロファイル全体の既定値です。既存の委任上限や並列数は変更されません。',
    delegationModelRequired: 'サブエージェント用のプロバイダーとモデルを選択してください',
    delegationSaved: 'サブエージェントモデルを保存しました',
    delegationSaveFailed: 'サブエージェントモデルを保存できませんでした',
  ...
  settings: {
    ...
    voice: {
      ...
      hermesConfigDescription: 'Hermes プロファイルの既存ネイティブプロバイダーは保持され、Web UI のプロバイダーは Ekko Studio として表示されます。',
      ...
      useHermesStudioProvider: 'Ekko Studio プロバイダーを使用',
  ...
  codingAgents: {
    ...
    notes: {
      claudeInstall: "Claude CLI をグローバルにインストールします。",
      codexInstall: "Codex CLI をグローバルにインストールします。",
      claudeAuth: "Claude のログイン状態を確認します。未ログインの場合は一度 claude を実行してください。",
  ...
  groupChat: {
    ...
    agentPresetAlreadyExists: 'このプリセットはすでに追加されています。',
    ...
    chooseAgentPreset: 'プリセットを選択',
    manageAgentPresets: 'プリセットを管理',
    searchAgentPresets: 'プリセットを検索',
    agentPresetsLoading: 'プリセットを読み込み中…',
    agentPresetsEmpty: 'Agent プリセットはまだありません。',
    agentPresetsNoResults: '一致するプリセットがありません。',
    saveCurrentAgentAsPreset: '現在の Agent を新しいプリセットとして保存',
    agentPresetOperationFailed: 'Agent プリセットを更新できませんでした。',
    applyAgentPreset: '適用',
    ...
    summarySettingsDesc: 'クリーンな Ekko が、指定した人間の会話ターン数ごとに共有要約を更新します。',
    ...
    agentHandoffRecommendation: '推奨深度: {count}',
    agentHandoffMaxDepth: '最大深度',
    agentHandoffUnlimited: '無制限',
    ...
    agentHandoffOutcomeUnknownTitle: 'リモート引き継ぎの結果が不明です',
    agentHandoffOutcomeUnknownDescription: 'リモートタスクはまだ実行中の可能性があります。重複実行を防ぐため、自動再試行や続行操作の再開は行わず、リモート結果を手動で確認する必要があります。',
  ...
  changelog: {
    new_0_7_22_1: '独立したタスク計画 MCP を追加。Hermes と Coding Agent でもチャットのタスク計画を更新でき、各ターンでタスクのコンテキストを更新 (#3053)',
    new_0_7_22_2: 'チャットの思考中表示に対応する Agent のロゴを表示 (#3052)',
    new_0_7_22_3: 'Ekko Chat の履歴でツール呼び出しと結果の対応を修正し、MCP HTTP トランスポートの別名に対応 (#3030, #3031)',
    new_0_7_22_4: 'Hermes Bridge で Studio 管理の Claude OAuth を修正し、ローカルソケットのパスが長すぎる場合に TCP へ切り替える処理を追加 (#3033, #3048)',
    new_0_7_22_5: 'グローバル Coding Agent セッションの Studio MCP ツールを補完し、実行ファイルの検索パスとコマンド未検出時のエラー表示を改善 (#3044, #3055)',
    new_0_7_22_6: 'Studio が生成する DSH プラグインのマニフェストにバージョンを宣言し、互換性を修正 (#3038)',
    new_0_7_22_7: 'API URL 設定の移行時に、空の BASE_URL が次の行を読み込んでしまう問題を修正 (#3046)',
    new_0_7_22_8: 'OpenRouter リクエストのアプリ名を Ekko Studio に統一 (#3056)',
    new_0_7_22_9: 'Grok のスコープ付きセッション設定で、複数行の配列・文字列・テーブル配列が切り捨てられたり誤って分割されたりする問題を修正 (#3072)',
    new_0_7_22_10: 'デスクトップ実行環境の梱包時にブラウザーの実行権限とシンボリックリンクが失われる問題を修正し、Hermes 0.21.3 に対応。実行環境のリリースがデスクトップの最新リリース表示を上書きしないよう修正 (#3073)',
    new_0_7_21_1: 'Windows で起動スクリプトの選択を誤ると DSH のプラグイン設定と Agent プリセットのページが開けない問題を修正 (#3026)',
    new_0_7_21_2: 'DSH 設定ランタイムの起動エラーに、失敗した段階とシステムエラーコードまたは終了コードを表示。プラグインのログや認証情報は公開しません (#3026)',
    new_0_7_20_1: 'DeepSeek Harness（DSH）のインストール管理と個別チャット・グループチャット・ワークフロー連携を追加。Agent プリセットの選択と再開時のモード保持に対応し、英語・中国語ガイドも更新 (#3020, #3023)',
    new_0_7_20_2: 'DSH 標準 Web プラグイン設定、プラグイン一覧、Agent プリセット管理を追加。コピー、既定の選択、カスタムプリセットの削除に対応。バックエンド側に DSH と Web 依存パッケージが必要 (#3020)',
    new_0_7_20_3: 'グループチャット Agent の作成・編集を右側ドロワーに変更。フォームはスクロール可能で操作ボタンは固定、モバイルでは画面幅全体を使用 (#3020)',
    new_0_7_20_4: 'Coding Agent 画面の共有スキルを読み取り専用にして誤編集・削除を防止。DSH 専用スキルは引き続き編集可能 (#3020)',
    new_0_7_20_5: 'Pi のインストール・更新で npm の最新版を使用し、有効なユーザー MCP アダプターを優先してツールや引数の重複登録を防止 (#2999, #2991)',
    new_0_7_20_6: 'グローバル Coding Agent の使用量とモデルの対応付けを修正。完了した応答の使用量を保持し、キャッシュトークン集計を改善。過去の記録は補完しない (#3005)',
    new_0_7_20_7: 'Grok の失敗ターンの使用量消失、カスタムプロバイダーのコンテキスト範囲、推論強度変更後の実行設定更新を修正 (#3002)',
    new_0_7_20_8: 'Docker 内で Studio からインストールした Coding Agent を Studio データボリュームに保存し、コンテナー再作成・更新後も保持。旧イメージでのインストールは一度再インストールが必要 (#3006)',
    new_0_7_20_9: 'OpenCode が非対応の /compact コマンドを非表示に変更。手入力時は現在のタスクを中断せず制限を案内 (#3010)',
    new_0_7_20_10: 'Hermes Agent 0.21 以降の承認セッションの関連付けを修正し、旧ランタイムとの互換性も維持 (#3018)',
    new_0_7_20_11: 'apikey の既定ドメインを apikey.fan に更新。起動時に既存 Hermes 設定の旧エンドポイントを一度移行し、パス・キー・モデル設定を保持 (#3022)',
    new_0_7_20_12: 'Linux のランチャー・ウィンドウアイコンに角丸と透明余白を適用し、見た目のサイズを調整 (#3008)',
    new_0_7_19_1: '名称を Ekko Studio に変更し、アプリアイコン、公式ドメイン、CLI コマンド、製品ドキュメントを統一 (#2966, #2980, #2981, #2992, #2994)',
    new_0_7_19_2: 'デスクトップの再起動ループ、更新中断、起動失敗を修正。アップグレード後もログインとブラウザデータを保持し、Windows の自動起動設定を移行 (#2931, #2979, #2988)',
    new_0_7_19_3: 'ネイティブの OpenCode Free を追加。API Key なしでチャット作成や Coding Agent の利用が可能になり、モデル一覧をバックグラウンドで取得 (#2932)',
    new_0_7_19_4: 'Ekko と Studio 経由の Coding Agent の OpenCode セッション互換性を修正。Hermes は引き続き Runtime の更新が必要 (#2996)',
    new_0_7_19_5: 'Ekko がタスク計画を保存し、進捗カードをリアルタイム表示。委任したバックグラウンドタスクの実行中はサイドバーの動作表示を維持 (#2952, #2961)',
    new_0_7_19_6: 'チャットのファイルリンクから引用行へ移動して強調表示。ワークスペースのファイルツリーは状態を保持したまま隙間なく折りたたみ可能 (#2947, #2965)',
    new_0_7_19_7: 'デスクトップの Web リンクを内蔵または既定のブラウザで開く設定を追加。内蔵パネルはページの読み込み完了前に表示 (#2928, #2956)',
    new_0_7_19_8: 'ブラウザ注釈の個別削除と取り消しに対応し、タブを閉じる際や注釈を消す際のエラーを修正 (#2949, #2944)',
    new_0_7_19_9: '読み上げで非表示の思考を除外し、負号やパーセント記号など意味のある記号を保持。Doubao TTS は 0.5～2 倍速に対応し、使用中のプロファイルと同期 (#2945, #2950, #2978)',
    new_0_7_19_10: 'Hermes と Ekko のスキル一覧で有効・無効スイッチの既定表示を復元 (#2933)',
    new_0_7_19_11: '更新版 App と連携し、チャットの承認・確認・実行終了、グループ Agent の返信、ワークフローの完了・失敗をフォアグラウンド通知。切断後の中継クリーンアップも修正 (#2940, #2946)',
    new_0_7_19_12: '更新版 App と連携し、セッションカテゴリごとのページ読み込みに対応。固定セッションの絞り込みとカテゴリ総数を正しく返却 (#2977, #2982)',
    new_0_7_19_13: '対応版 App を使い、ユーザー確認後に個別チャットから iOS の歩数・睡眠・心拍数などを読み取り可能。Android は未対応 (#2972)',
    new_0_7_19_14: '最新のお知らせのみを表示し、閉じた状態を記憶する Studio お知らせダイアログを追加。取得失敗時も利用を継続可能 (#2989)',
    new_0_7_19_15: 'Codex の複数行設定と Hook テーブルの保持、プロファイル再起動の早すぎるタイムアウト、任意パッチ失敗による Docker 起動停止を修正 (#2951, #2960, #2969)',
    new_0_7_19_16: 'Agent 自動更新ポリシーの基礎コードを追加。画面やバックグラウンド更新には未接続で、Agent の自動更新は行わない (#2923)',
    new_0_7_18_1: 'OpenCode を Coding Agent として追加し、セッション再開、ストリーミングツール呼び出し、設定、メモリ、Skills、ワークフロー、グループチャットに対応 (#2890)',
    new_0_7_18_2: 'グループチャットでクラウド中継経由のリモート Agent 接続に対応し、出力順序、再接続、要約の復元、共有画像へのアクセス、ツールの折りたたみ、モバイル表示を改善 (#2927)',
    new_0_7_18_3: 'モバイルの単発位置情報取得、カレンダー、リマインダー機能を追加。機密性の高い操作には同意を求め、削除対象を確認済み項目に限定し、同意のタイムアウトとリクエスト元を検証 (#2820, #2926)',
    new_0_7_18_4: 'セッション操作メニューを統一し、移動時のカテゴリ作成、更新後の折りたたみ状態保持、Ctrl/Cmd + , による設定表示に対応 (#2887, #2896, #2910, #2912)',
    new_0_7_18_5: '送信前のアップロード画像、コード形式のローカルファイルリンク、ワークスペースの Markdown をプレビュー可能にし、メッセージ参照を改善して返信矢印を復元 (#2885, #2893, #2903, #2908)',
    new_0_7_18_6: 'Runtime ダウンロードのポーリングを必要時のスーパー管理者のみに限定。Windows の展開を独立ディレクトリで行い、システム tar がない場合は Node tar を使用し、分離型 Hermes Runtime の Bridge MCP インポートを修正 (#2925)',
    new_0_7_18_7: 'Coding Agent が失敗した MCP Runtime を隔離し、削除済みサーバーをクリーンアップ。Studio 管理の MCP ランチャーは Node モードを明示し、余分な Electron ウィンドウの起動を防止 (#2888, #2920)',
    new_0_7_18_8: 'Ekko が繰り返すツール失敗から回復できるようになり、再試行とエラー処理を改善 (#2891)',
    new_0_7_18_9: '空の環境変数値が次の行を読み込む問題を修正し、モデル URL や認証情報の誤読を防止 (#2884)',
    new_0_7_18_10: 'アプリのダウンロードページに購入リンクを追加し、バージョンマニフェストのアクセスモードに応じて表示 (#2895)',
    new_0_7_17_1: 'Coding Agent 設定で Claude、Codex、Pi、Grok のナビゲーションが統一され、画面全体を使う「環境設定」と「構成」エディターが追加されました。Skills と MCP も Studio 共通のカードレイアウトと操作に揃いました (#2854, #2870, #2871)',
    new_0_7_17_2: 'Grok は失敗したターンの再開と実際に有効な Runtime 構成の表示に対応し、公式 npm レジストリからインストールされるようになりました。Codex のインストールも公式レジストリを使用します (#2855, #2857, #2868, #2881)',
    new_0_7_17_3: 'Ekko は過大なツール出力を制限し、メモリとワークスペースの処理を強化し、モデルプロバイダーで安全に扱えない MCP ツール名をプロキシするようになりました (#2846, #2847, #2849)',
    new_0_7_17_4: 'App 接続で本番リレーエンドポイントを復元し、権限エラーの表示、購入リンク、接続エラーのローカライズを追加しました (#2872, #2873, #2874)',
    new_0_7_17_5: 'Profile アバターは生成済み画像の代わりに決定的な Boring Avatars を使用し、画像ファイルを同梱せずに一貫した識別表示を保つようになりました (#2875)',
    new_0_7_17_6: 'Desktop のトレイから終了すると保留中の再起動が取り消され、処理済みの Runtime 再起動プロンプトは更新後も閉じた状態を維持します (#2842, #2852)',
    new_0_7_17_7: 'モバイルチャネルのバージョン報告を修正し、TTS は起動時に有効なプロバイダーを復元し、Skills は URL の予約文字を安全に処理するようになりました (#2839, #2843, #2845)',
    ...
    new_0_7_13_2: 'Hermes チャットの作成時に軽量な Agent 利用可否ステータスを再利用するようになりました。Hermes が未インストールの場合は管理者だけをインストール画面へ案内し、ステータス確認の失敗でチャット作成がブロックされることもありません (#2805)',
    new_0_7_13_3: 'Desktop、バックエンド Bridge、CLI がロックされた同一の Hermes 環境選択を共有するようになりました。バージョン管理では有効な CLI、環境情報、データディレクトリの上書き手順を表示し、不足する Runtime を必要に応じてインストールできます (#2808)',
    new_0_7_12_1: 'Windows では Hermes データの保存先を %USERPROFILE%\\.hermes に統一しつつ HERMES_HOME を引き続き尊重し、Desktop とバックエンドで同じ Profile を使用するようになりました（#2795）',
    new_0_7_12_2: 'Windows 上の Ekko と Hermes は、ロックされた Skill のリセットを後で再試行し、コマンド shim を正しく起動することで、EPERM と spawn EINVAL による起動失敗を防ぐようになりました（#2796）',
    new_0_7_12_3: 'Ekko は不完全なモデルのツール呼び出しを拒否し、再試行前に無効なツール呼び出し履歴を除去することで、function、name、arguments が空のエラーを防ぐようになりました（#2796）',
    new_0_7_12_4: 'データベース、Skills、メモリ、ログが個別に縮退できるようになりました。Core チャットは利用可能なまま、利用不能なモジュールを明示し、各障害の原因と修復コンテキストを提供します（#2797）',
    new_0_7_12_5: 'Ekko は安全な修復と修復後のセルフチェックを自動実行します。組み込み Skills とログディレクトリを復元し、データベースは再試行またはバックアップ後に再構築し、実行中の Run 完了後に Studio が永続ストレージを再読み込みします（#2797）',
    new_0_7_11_1: 'Ekko は従来形式と Responses 形式の OpenAI 互換ペイロードの両方で、DeepSeek の推論応答とツール呼び出しを処理できるようになりました（#2788）',
    new_0_7_11_2: 'Agent Bridge はシェルでラップされたランタイム起動を復旧し、無関係な子孫プロセスを無視して、実際の broker 準備完了シグナルを待機するようになりました（#2789）',
    new_0_7_11_3: '保留中の承認・質問・選択肢に同期されたカウントダウンを表示し、安全に再開して、チャットとグループチャットで古いタイムアウトエラーが残らないようにしました（#2790）',
    new_0_7_11_4: 'アップグレード時に Skill ディレクトリ全体を組み込み Skills で一度だけ置換し、完了マーカーを原子的に保存することで、以降の起動時に Windows で Git ディレクトリ削除がクラッシュする問題を回避しました（#2792）',
    new_0_7_11_5: '不正な WebSocket 要求やログ、Runtime、Ekko、データベース初期化の異常から起動を保護しました。Desktop はすぐに画面を開き、正常系を変えずにバックエンドまたは renderer の終了から復旧します（#2792）',
    new_0_7_1_1: 'Ekko のメモリ書き込みと忘却は、タイムアウトや古いカードの復元につながるモデル承認・バックグラウンド審査キューを介さず、保存済みメモリを直接更新するようになりました（#2785）',
    new_0_7_1_2: '非表示のローリング会話要約パイプラインと、関連する審査ワーカー、設定、API、UI 状態、データベーステーブルを削除しました（#2785）',
    new_0_7_1_3: '全メモリの一覧・消去が確実に動作し、メモリツールの失敗時は明確なエラーで実行を停止します。データベース更新ではロック再試行、原本バックアップ、スキーマ再構築、互換データ復元に対応しました（#2785）',
    new_0_7_0_1: 'このリリースには v0.6.47 以降にマージされた全 21 件の PR が含まれ、Ekko の完全統合、Agent ランタイム管理の統一、チャット状態の保持強化、Studio の互換性と信頼性向上を実現します',
    new_0_7_0_2: 'Ekko は Studio が完全に管理するランタイムとなり、Profile Agent、会話、管理対象メモリ、組み込み・外部スキル、MCP サーバー、専用設定ページを利用できます (#2752, #2770)',
    new_0_7_0_3: 'Ekko は安全なツール呼び出しの並列実行、バージョン付きグローバル Agent 設定の永続化に対応し、Navicat で確認しやすい単一の ekko.db を含むすべての開発データを packages/ekko-agent/.ekko に保存します。また、自身の専用スキルだけを自動インストールし、Hermes スキルはコピーしません (#2772, #2775, #2776)',
    new_0_7_0_4: '統合された「Agents」マネージャーが Hermes Runtime の検出、選択、起動、再起動、プロバイダートークン、ライブ状態を管理します。ページ表示時はキャッシュ済み状態を使い、時間のかかる検出は更新時のみ実行します (#2760, #2761)',
    new_0_7_0_5: 'チャットでは画面移動後も思考経過時間を保持し、再利用されたツール呼び出し ID を実行ごとに分離し、停止、クリーンアップ、サーバー再起動後もグローバル Coding Agent のコンテキストを再開できます (#2723, #2730, #2735)',
    new_0_7_0_6: '添付ファイル転送は正しいコンテンツ種別、分割アップロード・ダウンロード、進捗、キャンセル、安全なファイル名、動画プレビューに対応しました。Codex リクエストは現在のターンを残して過去のインライン画像を除去します (#2732, #2773)',
    new_0_7_0_7: '「最近」からチャットを選んだ場合、画面移動や更新後も実際のカテゴリの折りたたみ状態が維持され、個別・グループチャットには正しい Profile、メンバー、Agent の識別情報が表示されます (#2742, #2754, #2755)',
    new_0_7_0_8: 'グローバル Coding Agent チャットでは効果のない推論強度セレクターを表示しなくなり、Weixin の連携通知には配信制限と通知を再開する方法が追加されました (#2728, #2731)',
    new_0_7_0_9: 'サーバーの責務を正式な Studio、Hermes、Ekko、Coding Agent モジュールに分割しつつ、旧 MCU ルートの互換性を保ち、終了時には Studio が所有するプロセスツリーを確実にクリーンアップします (#2744, #2746, #2747)',
    new_0_7_0_10: '英語版と中国語版の README を更新し、5 つのランタイム、3 つの Agent ファミリー、モジュール所有権、正式 API、現在の開発・検証フローを説明しました (#2745)',
    new_0_7_0_11: 'デバイス連携のダウンロードカードは Android と iOS のみになり、Apple の正式版は TestFlight · App Store ではなく App Store と表示されます',
  },
}
