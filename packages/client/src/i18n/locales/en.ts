...
export default {
  ...
  dshPlugins: {
    ...
    "nativeHint": "These are preset plugin entries. Selecting a preset changes only the preview. Status labels describe configuration, not live activation.",
    "nativeFailed": "Unable to read this native preset configuration. Check the DSH installation and source files.",
    ...
    "conflict": "Configuration changed elsewhere. Your draft is preserved; compare with the latest version before reloading.",
  ...
  ekkoConfig: {
    ...
    "authorizationLeewayMs": "Authorization refresh leeway (ms)",
    "toolsEnabled": "Tools enabled",
    "toolTimeoutMs": "Tool timeout (ms)",
    "approvalsEnabled": "Tool approvals",
    "approvalTimeoutMs": "Approval timeout (ms)",
    "permanentAllow": "Permanently allowed tools",
    "codeExecEnabled": "Code execution",
    "codeExecLanguages": "Code execution languages",
    "codeExecTimeoutMs": "Code execution timeout (ms)",
    "codeExecMaxCalls": "Code execution tool-call limit",
    "maxOutputBytes": "Maximum output bytes",
    "maxStderrBytes": "Maximum stderr bytes",
    "maxSourceBytes": "Maximum source bytes",
    "memoryEnabled": "Memory enabled",
    "recentMessageLimit": "Recent message limit",
    "recallTokenBudget": "Automatic recall token budget",
    "memorySearchLimit": "Memory search result limit",
    "skillsEnabled": "Skills enabled",
    "skillReviewInterval": "Review every tool calls",
    "mcpEnabled": "MCP enabled",
    "logMaxBytes": "Maximum log file bytes",
    "promptInstructions": "Global prompt instructions",
  ...
  agentManager: {
    ...
    path: 'Path',
    userCli: 'Hermes CLI',
    userCliReadonly: 'Ekko Studio checks the current environment for a CLI first; CLI installations remain user managed.',
    readOnly: 'Read only',
    ...
    deleteOperation: 'removal',
    aiHelpDialogTitle: '{name} operation failed',
    aiHelpDialogQuestion: '{operation} for {name} failed. Would you like Ekko AI to diagnose the problem?',
    aiHelpDialogPositive: 'Ask AI',
    ...
    legacyDataMigrationDescription: 'Ekko Studio found data in a legacy Windows data directory. Would you like to migrate it to the current data directory?',
    ...
    legacyDataMigrationSuccess: 'Migration scheduled. Ekko Studio will restart and migrate the data before starting local services.',
  ...
  runtimeVersions: {
    ...
    activePythonPath: 'Current Python path',
    activeAgentRoot: 'Current Agent Root',
    viewCliDetails: 'View',
    cliDetailsTitle: 'Hermes CLI details',
    activeDataDirectory: 'Current data directory',
    dataDirectoryEnvDescription: 'This directory can be overridden by the HERMES_HOME environment variable. If it is incorrect, set HERMES_HOME to the data directory you want to use.',
    dataDirectoryEnvInstructions: 'Environment variable setup for each platform',
    dataDirectoryEnvWindows: 'Windows PowerShell (current user)',
    ...
    dataDirectoryEnvRestart: 'Fully quit and reopen Ekko Studio after changing it. On Windows or Linux, sign out and back in if the desktop app still sees the old value.',
    cliUpdateDescription: 'Hermes Runtime 0.19.1 and later can use the following command to update the bundled Hermes Agent only. It does not update the Ekko Studio desktop app or Web UI. Fully quit Ekko Studio before running:',
    webUiTitle: 'Web UI',
    platform: 'Platform',
    ...
    runtimeDirectorySaved: 'Runtime migration scheduled. Restart Ekko Studio to apply it.',
    ...
    runtimeActivationFailed: 'The selected Runtime could not start, so Ekko Studio used another installed version',
    active: 'Active',
    installed: 'Installed',
    download: 'Download',
    ...
    activateSuccess: 'Version selection saved. Restart Ekko Studio to use it.',
  ...
  connections: {
    ...
    app: {
      ...
      downloadTitle: 'Ekko Studio on your phone',
      ...
      downloadPaidDescription: 'The Ekko Studio App is now officially available as a paid product. To get started, visit the pricing and purchase page, choose the plan that suits you, and complete your purchase.',
      ...
      routeTitle: 'Cloud route',
      routeDescription: 'The route used by Studio for cloud connections; you can switch it at any time',
      qrRouteDescription: 'The QR code identifies the Studio route without changing the App route',
      officialRoute: 'Official direct',
      cloudflareRoute: 'Cloudflare',
      routeSwitched: 'Cloud route switched',
      routeSwitchFailed: 'Failed to switch the cloud route',
      remainingTime: '{time} remaining',
      authorizationExpired: 'Authorization code expired',
      regenerate: 'Generate again',
      refreshQr: 'Refresh QR code',
      cloudPending: 'Cloud connection is not configured yet',
      authorizationFailed: 'Failed to generate App authorization code',
      refreshTooSoon: 'QR code refreshed too frequently. Try again shortly',
      refreshLimitReached: 'The QR refresh limit for this connection has been reached',
      preconnectionExpired: 'The preconnection expired. Reopen the scan dialog',
      cloudUnavailable: 'Unable to connect to the cloud service. Try again later',
      accessFailureTitle: 'Latest App connection failure',
      ...
      accessFailures: {
        ...
        cloudSubscriptionRequired: 'This account does not have Ekko Studio Cloud access',
        ...
        accountMismatch: 'The entitlement account does not match the current App account',
        deviceMismatch: 'The entitlement device code does not match this device',
        unknown: 'App access entitlement verification failed',
      },
      deviceName: 'Device name',
      deviceBrand: 'Device brand',
      deviceModel: 'Device model',
      deviceCode: 'Device code',
      connectionDetected: 'App connected',
      connectionType: 'Connection type',
      authorizedUser: 'Authorizing user',
      connectionTypes: {
        lan: 'LAN',
        cloud: 'Cloud',
      },
      ...
      actions: 'Actions',
      delete: 'Delete',
      deleteConfirm: 'Delete the App connection for “{name}”?',
      deleted: 'App connection deleted',
      deleteFailed: 'Failed to delete App connection',
  ...
  chat: {
    ...
    threadSegments: '{total} segments · viewing segment {index}',
    ...
    pushNotConfigured: 'Configure Message Push in Ekko Studio “Device Connections” before enabling it.',
    hideToolCalls: 'Hide tool calls',
    messageQueue: 'Message queue',
    removeQueuedMessage: 'Remove queued message',
    insertQueuedMessage: 'Insert queued message',
    ...
    queueInsertionStopping: 'Stopping the current response',
    stop: 'Stop',
    start: 'Start',
    ...
    obsidianSaveFailed: 'Obsidian save failed',
    ...
    workspaceExtraDirs: 'Additional directories (agent gets read/write access)',
    workspaceProject: 'Project (multi-directory workspace)',
  ...
  models: {
    ...
    auxiliaryTasksTitle: 'Auxiliary task models',
    delegationTitle: 'Subagent default model',
    delegationSubtitle: 'Used by subagents created through delegation. When unset, they inherit the main model.',
    delegationInheritMain: 'Follow main model',
    delegationInheritReasoning: 'Follow main session',
    delegationReset: 'Reset to inherit',
    delegationFormHint: 'This is the Profile-wide default. Existing delegation limits and concurrency settings are left unchanged.',
    delegationModelRequired: 'Select a provider and model for subagents',
  ...
  settings: {
    ...
    voice: {
      ...
      hermesConfigDescription: 'Existing native providers remain in the Hermes profile. Web UI providers appear to Hermes as Ekko Studio.',
      ...
      useHermesStudioProvider: 'Use Ekko Studio provider',
  ...
  codingAgents: {
    ...
    notes: {
      claudeInstall: "Installs the Claude CLI globally.",
      codexInstall: "Installs the Codex CLI globally.",
      claudeAuth: "Checks Claude login state; run claude once if login is missing.",
  ...
  groupChat: {
    ...
    agentPresetAlreadyExists: 'This preset has already been added.',
    ...
    chooseAgentPreset: 'Choose preset',
    manageAgentPresets: 'Manage presets',
    searchAgentPresets: 'Search presets',
    agentPresetsLoading: 'Loading presets…',
    agentPresetsEmpty: 'No Agent presets yet.',
    agentPresetsNoResults: 'No presets match your search.',
    saveCurrentAgentAsPreset: 'Save current Agent as new preset',
    agentPresetOperationFailed: 'Could not update Agent presets.',
    applyAgentPreset: 'Apply',
    ...
    summarySettingsDesc: 'A clean Ekko updates the shared room summary after the configured number of completed human turns.',
    summaryProvider: 'Summary Provider',
    summaryProviderPlaceholder: 'Select a provider',
    summaryModel: 'Summary Model',
    summaryModelPlaceholder: 'Select a model',
    summaryApiMode: 'API Mode',
    summaryEveryTurns: 'Summarize Every N Effective Utterances',
    summaryEveryTurnsDesc: 'Each public natural-language message from a human or Agent counts; Tool, reasoning, and status records do not.',
    summaryConfigSaved: 'Summary settings saved',
    agentHandoffTitle: 'Agent handoff',
    agentHandoffEnabled: 'Enable automatic Agent handoff',
    agentHandoffRecommendation: 'Recommended depth: {count}',
    agentHandoffMaxDepth: 'Maximum depth',
    agentHandoffUnlimited: 'Unlimited',
    ...
    summarizedTurns: 'Summarized effective utterances',
