  ...
  connections: {
    ...
    app: {
      ...
      accessFailures: {
        ...
        cloudSubscriptionRequired: 'Dieses Konto hat keinen Zugriff auf HStudio Cloud',
...
jobTriggered: 'Job ausgelost',
  ...
  usage: {
    ...
    agents: { hermes: 'Hermes Agent', claudeCode: 'Claude', codex: 'Codex', pi: 'Pi', grok: 'Grok', ekkoAgent: 'Ekko', unknown: 'Unbekannt' },
